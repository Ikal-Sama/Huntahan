...
import { acceptFriendRequest, addFriend, cancelFriendRequest, checkAuth, declineFriendRequest, getFriendRequests, login, logout, signup, unFriend, updateProfile } from '../controllers/auth.controller.js';
