        ...
        <div className='mt-3 hidden lg:flex items-center gap-2'>
          <label className='cursor-pointer flex items-center gap-2'>
            <input
              ...
              className='checkbox checkbox-sm checkbox-warning border'
            />

            <span className='text-sm text-yellow-700'>Show online only</span>
          </label>
      ...
      <div className='overflow-y-auto w-full py-3 scrollbar-custom'>
        {filteredUsers.map((user) => (
          <button
            ...
            className={`w-full p-3 flex items-center gap-3 hover:bg-accent transition-colors cursor-pointer
            ${
